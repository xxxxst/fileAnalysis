...
.home {
	...
	>.map-box {
		position: absolute; background: #fff; top: 50px; left: 200px; width: 646px; bottom: 345px;
	}

	>.hex-box {
		position: absolute; background: #fff; left: 200px; bottom: 25px; width: 650px; height: 320px; border-top: 1px solid #acacac;
		>.hex-fill-box { pointer-events: none; position: absolute; left: 85px; top: 24px; width: 550px; height: 288px; }
	}
	
	>.config-box {
		position: absolute; background: #fff; top: 50px; right: 0; left: 200px+650px; bottom: 25px; border-left: 1px solid #acacac;
		>.title {
