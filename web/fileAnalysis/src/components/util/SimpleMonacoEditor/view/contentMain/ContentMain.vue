...
<div class="content-main" :style="rootStyle" @mousedown="onContentBoxMouseDownMainArea($event)">
...
<script lang="ts">
import ctl from "./ContentMainTs";
export default ctl;
</script>

<style lang="scss">

.simple-monaco-editor .content-main {
	position: absolute; left: 0; top: 0; width: 100%; height: 0; cursor: text;
	color: #d4d4d4;
	>.line {
		display: block;
